...
import UploadImageApi2 from '../../api/uploadIndex';
                ...
                <Carousel onClickItem=
                    {   
                        (e) => {
                                ...
                                // const path_image = `img/${e + 1}.jpg`  
                                // const data= new FormData()
                                // console.log(path_image)
                                // data.append("image", path_image)
                                // console.log(data)
                                // UploadImageApi.postImage(data).then((res, data) => {
                                //     console.log("Successful Stage 1")
                                // }).catch((err) => {
                                // }) 
                                // let file
                                ...
                                // file = new Blob(
                                //     [
                                //     "https://thesis-vqa.s3.ap-southeast-1.amazonaws.com/283e386dddb82ae673a9.jpg?fbclid=IwAR2L3-0mUK55BJvAKBYpaHEcqDv3J-Ie1kyNiCe3AW8KWtxJaWGcM6xhMMY"
                                //     ],
                                //     { type: "image/*" }
                                // );
                                ...
                                data.append("image_id", `${e + 1}`)
                                UploadImageApi2.postImage(data).then((res, data) => {
                                }).catch((err) => {
                                }) 
